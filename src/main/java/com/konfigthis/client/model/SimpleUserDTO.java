...
public class SimpleUserDTO {
  ...
  public SimpleUserDTO userId(String userId) {
  ...
  **/
   ...
   * @return the SimpleUserDTO instance itself
   */
  public SimpleUserDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, simpleUserDTO.userId) &&
        Objects.equals(this.username, simpleUserDTO.username)&&
        Objects.equals(this.additionalProperties, simpleUserDTO.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimpleUserDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimpleUserDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SimpleUserDTO>() {
           ...
           public SimpleUserDTO read(JsonReader in) throws IOException {
             ...
             SimpleUserDTO instance = thisAdapter.fromJsonTree(jsonObj);
